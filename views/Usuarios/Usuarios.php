...
<div class="container mt-5">
    ...
    <div class="table-responsive">
        <div class="mb-4 text-left">
            <a href="insertar_Usuario.php" class="btn btn-success me-2">➕ Insertar</a>
        ...
        <?php
                      if (!empty($datos)) {
                          ...
                          foreach ($datos as $dato) {
                              echo '<tr>';
                              echo '<td>' . htmlspecialchars($dato['ID_USUARIO']) . '</td>';
                              ...
                              echo '<a href="actualizar_Usuario.php?id=' . $dato['ID_USUARIO'] . '" class="btn btn-warning btn-sm me-2">Editar</a>';
                              echo '<a href="eliminar_Usuario.php?id=' . $dato['ID_USUARIO'] . '" class="btn btn-danger btn-sm">Eliminar</a>';
                              echo '</div>';                              
                              echo '</td>';                                                           
                              echo '</tr>';
                          }
