...
<head>
    ...
    <title>✏️ Actualizar Empleado - Bigotitos</title>
    ...
    <div class="container my-5">
        <div class="card shadow">
            <div class="card-header bg-warning text-white text-center">
                <h4 class="card-title">✏️ Actualizar Empleado</h4>
            </div>
            <div class="card-body">
                <form action="../../Controller/EmpleadosController.php" method="POST">
                    ...
                    <div class="d-grid">
                        <button type="submit" name="btnActualizarEmpleado" class="btn btn-warning">
