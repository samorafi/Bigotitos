...
<head>
    ...
    <title>🗑️ Eliminar Categoría - Bigotitos</title>
    ...
    <div class="container my-5">
        <div class="card shadow">
            <div class="card-header bg-danger text-white text-center">
                <h4 class="card-title">🗑️ Eliminar Categoría</h4>
            </div>
            <div class="card-body">
                <form action="../Controller/CategoriasController.php" method="POST">
                    ...
                    <div class="d-grid">
                        <button type="submit" name="btnEliminarCategoria" class="btn btn-danger">
