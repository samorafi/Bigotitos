...
<head>
    ...
    <title>✏️ Actualizar Usuario - Bigotitos</title>
    ...
    <div class="container my-5">
        <div class="card shadow">
            <div class="card-header bg-warning text-white text-center">
                <h4 class="card-title">✏️ Actualizar Usuario</h4>
            </div>
            <div class="card-body">
                <form action="../../Controller/UsuariosController.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="txtApellido" class="form-control" placeholder="Ingrese el nuevo apellido" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Nuevo Teléfono:</label>
                        <input type="text" name="txtTelefono" class="form-control" placeholder="Ingrese el nuevo teléfono" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Nuevo Correo:</label>
                        <input type="email" name="txtCorreo" class="form-control" placeholder="Ingrese el nuevo correo" required>
                    </div>

                    <div class="d-grid">
                        <button type="submit" name="btnActualizarUsuario" class="btn btn-warning">
