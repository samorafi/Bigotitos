...
<head>
    ...
    <title>🗑️ Eliminar Detalle de Venta - Bigotitos</title>
    ...
    <div class="container my-5">
        <div class="card shadow">
            <div class="card-header bg-danger text-white text-center">
                <h4 class="card-title">🗑️ Eliminar Detalle de Venta</h4>
            </div>
            <div class="card-body">
                <form action="../../Controller/DetalleVentaController.php" method="POST">
                    ...
                    <div class="d-grid">
                        <button type="submit" name="btnEliminarDetalleVenta" class="btn btn-danger">
