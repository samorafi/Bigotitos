...
$id_cliente =  $_GET["id"];
$datos = ConsultarCliente($id_cliente);
?>
...
<div class="container form-container">
    <h2 class="text-center form-title">✏️ Actualizar Cliente</h2>
    ...
    <form action="" method="POST">
        <input type="hidden" id="txtIdCliente" name="txtIdCliente" value="<?php echo $datos["ID_CLIENTE"] ?>">
        ...
        <div class="mb-3">
            ...
            value="<?= $datos ? htmlspecialchars($datos['DIRECCION']) : '' ?>">
        </div>

        <div class="text-center mt-4">
            <input type="submit" class="btn btn-custom w-100 py-2" value="Actualizar Información" id="btnActualizarCliente" name="btnActualizarCliente">
        </div>
